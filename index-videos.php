...
<div class="wrapper">
    ...
    <section class="videos-container">
        <h1 class="tittle-store">Видео</h1>
        <div class="videos">
            <div class="first-row">
                <div class="video-pair">
                    <iframe class="video" src="https://www.youtube.com/embed/SXegK7H6pTU"
                            frameborder="0" allow="autoplay; encrypted-media" allowfullscreen>
                    </iframe>
                    <span class="element-title">250 years of Faber-Castell - Art & Graphic Anniversary Case</span>
                </div>
                <div class="video-pair">
                    <iframe class="video" src="https://www.youtube.com/embed/YnLw3vUEI8U"
                            frameborder="0" allow="autoplay; encrypted-media" allowfullscreen>
                    </iframe>
                    <span class="element-title">Faber-Castell KARLBOX</span>
                </div>
            </div>
            <div class="second-row">
                <div class="video-pair">
                    <iframe class="video" src="https://www.youtube.com/embed/vz2MXyDF_v8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    <span class="element-title">POSCA Video</span>
                </div>
            </div>
        </div>
    </section>
